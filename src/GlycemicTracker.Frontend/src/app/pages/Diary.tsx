  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <div className="font-bold" style={{ color: "#1C1C1C" }}>
              Edit entry
            </div>
            <div className="text-xs italic mt-0.5" style={{ color: "#6B6B6B" }}>
            ...
            <div className="flex gap-2 mt-2 flex-wrap">
              {[50, 100, 150, 200, 300].map((g) => (
                <button
                  ...
                  style={{
                    borderColor: grams === g ? "#3D6B4F" : "#EDE8DF",
                    backgroundColor: grams === g ? "#E8F5EC" : "transparent",
            ...
            <div className="grid grid-cols-3 gap-1.5">
              {PREP_METHODS.map((m) => (
                <button
                  ...
                  style={{
                    borderColor: prep === m ? "#3D6B4F" : "#EDE8DF",
                    backgroundColor: prep === m ? "#E8F5EC" : "transparent",
                    color: prep === m ? "#3D6B4F" : "#6B6B6B",
                    fontWeight: prep === m ? 600 : 400,
                  }}
                >
                  {m}
                </button>
            ...
            <div className="grid grid-cols-4 gap-1.5">
              {MEAL_TYPES.map((m) => (
                <button
                  ...
                  className="py-1.5 rounded-lg text-xs border transition-all text-center"
                  style={{
                    borderColor: meal === m ? "#3D6B4F" : "#EDE8DF",
                    backgroundColor: meal === m ? "#E8F5EC" : "transparent",
                    color: meal === m ? "#3D6B4F" : "#6B6B6B",
...
const QUICK_PREPS = PREP_METHOD_LIST as unknown as {
  id: string;
  label: string;
  multiplier: number;
  icon: string;
...
function AddFoodModal({ onAdd, onClose }: AddFoodModalProps) {
  ...
  const [selectedFood, setSelectedFood] = useState<
    (typeof QUICK_FOODS)[0] | null
  >(null);
  const [selectedPrep, setSelectedPrep] = useState<
    (typeof QUICK_PREPS)[0] | null
  >(null);
  ...
  const adjGI =
    selectedFood && selectedPrep
      ? selectedFood.gi * selectedPrep.multiplier
      : 0;
  ...
  return (
    ...
    >
      <div
        className="bg-white w-full md:max-w-[520px] rounded-t-2xl md:rounded-2xl overflow-hidden"
        style={{
      ...
      >
        ...
        >
          <div>
            ...
            <div className="text-xs mt-0.5" style={{ color: "#6B6B6B" }}>
              Log a new meal entry for today
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto flex-1 px-5 py-4 flex flex-col gap-5">
              ...
              {filtered.slice(0, 5).map((food) => (
                <button
                  ...
                  style={{
                    ...
                    backgroundColor:
                      selectedFood?.id === food.id ? "#E8F5EC" : "white",
                  }}
                >
                  <div
            ...
            <div className="grid grid-cols-3 gap-1.5">
              {QUICK_PREPS.map((p) => (
                <button
                  ...
                  style={{
                    border:
                      selectedPrep?.id === p.id
                        ? "1px solid #3D6B4F"
                        : "1px solid #EDE8DF",
                    backgroundColor:
                      selectedPrep?.id === p.id ? "#E8F5EC" : "white",
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex gap-1.5 mt-2">
                {[100, 150, 200, 300].map((g) => (
                  <button
                    ...
                    style={{
                      border:
                        grams === g ? "1px solid #3D6B4F" : "1px solid #EDE8DF",
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-1">
                {(
                  ["Breakfast", "Lunch", "Dinner", "Snack"] as Entry["meal"][]
                ).map((m) => (
                  <button
                    key={m}
                    onClick={() => setMeal(m)}
                    ...
                    style={{
                      border:
                        meal === m ? "1px solid #3D6B4F" : "1px solid #EDE8DF",
                      backgroundColor: meal === m ? "#E8F5EC" : "white",
                      color: meal === m ? "#3D6B4F" : "#6B6B6B",
                      fontWeight: meal === m ? 600 : 400,
                    }}
                  >
          ...
          {selectedFood && selectedPrep && (
            <div
              className="rounded-xl px-4 py-3 flex items-center justify-between"
              style={{
                background: "linear-gradient(135deg, #1A3829, #2D5540)",
              }}
            >
              <div
                className="text-xs"
              ...
              >
                {grams}g {selectedFood.name} · {selectedPrep.label}
              </div>
              <div
        ...
        >
          <button
            ...
            style={{
              backgroundColor:
                selectedFood && selectedPrep ? "#3D6B4F" : "#EDE8DF",
...
export function Diary() {
  ...
  const glStatusColor =
    glToday > glTarget ? "#C4673A" : glToday > 80 ? "#D4923A" : "#3D6B4F";
    ...
    <div className="max-w-[800px] mx-auto px-6 py-8 relative">
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(111,212,154,0.2) 0%, transparent 70%)",
          }}
        />
        <div className="relative z-10 flex items-center justify-between mb-4">
          ...
          <span
            ...
            style={{
              backgroundColor:
                glToday > glTarget
                  ? "rgba(196,103,58,0.25)"
                  : "rgba(111,212,154,0.2)",
        ...
        <div
          className="relative z-10 h-2.5 rounded-full overflow-hidden"
            ...
            {items.map((entry) => (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: MEAL_COLORS[entry.meal] ?? "#6B6B6B",
                    boxShadow: `0 2px 8px ${MEAL_COLORS[entry.meal] ?? "#6B6B6B"}44`,
                  }}
                >
                  {entry.name[0]}
                </div>
                ...
                >
                  ...
                  <span
                    style={{
                      color: multColor(
                        parseFloat(entry.multiplier.replace("×", "")),
                      ),
                      fontVariantNumeric: "tabular-nums",
                    }}
                  >
                ...
                <div className="relative shrink-0">
                  ...
                  {openMenuId === entry.id && (
                    ...
                    >
                      ...
                      >
                        <Pencil size={13} style={{ color: "#3D6B4F" }} /> Edit
                        entry
                      </button>
      ...
      {/* ── Add Food Modal ────────────────────────────────── */}
      {showAddFood && (
        <AddFoodModal onAdd={addEntry} onClose={() => setShowAddFood(false)} />
      )}
    </div>
  );
}
